...
def main():
    ...
    while True:
        ...
        if turn == player1Sign:
            ...
            # s = [64, 16, 16, 1]
            s = [64, 40, 20, 1]
            # currentFigurePositions = MCTSplayer(array(currentFigurePositions), turn, ai2theta2(contestant, s), s, 1, \
            #                          save,
            #                                     300)
            currentFigurePositions = fastalphabetannplayer(array(currentFigurePositions), turn, ai2theta2(contestant,
                                                                                                          s),
                                                       s, save, depth=3)
